...
<div id="i-sec-s" class="i-sec" <?php echo lsv07i_isec('s',$first);?>>
 ...
 <div class="i-tabs">
  <?php if($T('sw_mann')):?><button class="i-tab" data-panel="i-p-mann">Mannschaften</button><?php endif;?>
  <?php if($T('sw_anw')):?><button class="i-tab" data-panel="i-p-anw">Anwesenheit</button><?php endif;?>
  <?php if($T('sw_wk')):?><button class="i-tab" data-panel="i-p-wk">Wettkämpfe</button><?php endif;?>
  <?php if($T('sw_spr')):?><button class="i-tab" data-panel="i-p-spr">Springer</button><?php endif;?>
  <?php if($T('sw_bz')):?><button class="i-tab" data-panel="i-p-bz">Bestzeiten</button><?php endif;?>
  <?php if($T('sw_refl')):?><button class="i-tab" data-panel="i-p-refl">Reflexion</button><?php endif;?>
  <?php if($T('sw_trainer')):?><button class="i-tab" data-panel="i-p-sw-trainer">Trainer</button><?php endif;?>
 </div>
